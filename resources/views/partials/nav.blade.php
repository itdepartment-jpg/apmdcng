                ...
                <div class="relative group" id="services-dropdown">
                    ...
                    <div
                        ...
                        <div class="relative group/sub">
                            ...
                            <div
                                class="absolute left-full top-0 ml-1 w-56 bg-white rounded-md shadow-lg py-2 z-20 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-200 transform translate-x-2 border border-gray-100">
                    ...
                    <div class="mobile-dropdown-content hidden pl-4 mt-2 space-y-3 pb-2">
                        ...
                        <div class="mobile-sub-dropdown">
                            <button
                                ...
                                Oil and Gas
                                <svg class="w-3 h-3 transition-transform duration-300 mobile-sub-dropdown-icon"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function setupMobileDropdowns() {
            ...
            subDropdownButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    const allSubContents = parentDropdown.querySelectorAll(
                        '.mobile-sub-dropdown-content');
                    const allSubIcons = parentDropdown.querySelectorAll(
        ...
        function closeAllMobileDropdowns() {
            const dropdownContents = document.querySelectorAll(
                '.mobile-dropdown-content, .mobile-sub-dropdown-content');
