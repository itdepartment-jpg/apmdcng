...
const imagePreview = ref(
    props.leader.image_path
        ? `/storage/${props.leader.image_path}`
        : null
);
...
const submit = () => {
    form.put(route("leadership.update", props.leader.id), {
        forceFormData: true,
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-8 flex justify-end gap-3">
                        ...
                        >
                             {{ form.processing ? "Updating Leader..." : "Update Leader" }}
                        </button>
